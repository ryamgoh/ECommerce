...
public class UserService extends UserServiceGrpc.UserServiceImplBase {
  ...
  public void createUser(CreateUserRequest request, StreamObserver<CreateUserResponse> responseObserver) {
    try {
      ...
      // Send response
      responseObserver.onNext(CreateUserResponse.newBuilder().setUser(responseUser).build());
      responseObserver.onCompleted();

    } catch (Exception e) {
      responseObserver.onError(Status.INTERNAL.withDescription("Error creating user: " + e.getMessage()).withCause(e).asRuntimeException());
    }
  }
  ...
  public void getUser(GetUserRequest request, StreamObserver<GetUserResponse> responseObserver) {
    try {
      ...
      responseObserver.onError(Status.INTERNAL.withDescription("Error getting user: " + e.getMessage()).withCause(e).asRuntimeException());
    }
  }
  ...
  public void updateUser(UserProto.UpdateUserRequest request, StreamObserver<UserProto.UpdateUserResponse> responseObserver) {
    try {
      ...
      responseObserver.onNext(UserProto.UpdateUserResponse.newBuilder().setUser(updatedUser).build());
      responseObserver.onCompleted();
    } catch (Exception e) {
      responseObserver.onError(Status.INTERNAL.withDescription("Error updating user: " + e.getMessage()).withCause(e).asRuntimeException());
    }
  }
  ...
  public void deleteUser(UserProto.DeleteUserRequest request, StreamObserver<UserProto.SuccessResponse> responseObserver) {
    try {
      ...
      responseObserver.onNext(UserProto.SuccessResponse.newBuilder().setSuccess(true).build());
      responseObserver.onCompleted();
    } catch (Exception e) {
      responseObserver.onError(Status.INTERNAL.withDescription("Error deleting user: " + e.getMessage()).withCause(e).asRuntimeException());
    }
  }
  ...
  public void getAllUsers(UserProto.GetAllUsersRequest request, StreamObserver<UserProto.GetAllUsersResponse> responseObserver) {
    try {
      ...
      UserProto.GetAllUsersResponse response = UserProto.GetAllUsersResponse.newBuilder().addAllUsers(userEntities.stream().map(UserEntity::toProto).toList()).build();
      responseObserver.onNext(response);
      responseObserver.onCompleted();
    } catch (Exception e) {
      responseObserver.onError(Status.INTERNAL.withDescription("Error getting all users: " + e.getMessage()).withCause(e).asRuntimeException());
    }
  }
}
